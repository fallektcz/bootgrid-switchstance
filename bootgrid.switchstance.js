/*! 
 * jQuery Bootgrid v1.3.1 - 09/11/2015 modified by Switchstance
    ...
    */
    ...
    function setTableHeaderSortDirection(element)
    {
        ...
        var css = this.options.css,
            ...
            columnSqlName = element.parents("th").first().data("column-sql-name") || columnId,
            sortOrder = this.sortDictionary[columnSqlName],
        ...
        {
            this.sortDictionary[columnSqlName] = "desc";
        ...
        else if (sortOrder && sortOrder === "desc")
        {
            ...
            {
                this.sortDictionary[columnSqlName] = "asc";
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            headerCell: "<th data-column-id=\"{{ctx.column.id}}\" data-column-sql-name=\"{{ctx.column.sqlName}}\" class=\"{{ctx.css}}\" style=\"{{ctx.style}}\"><a href=\"javascript:void(0);\" class=\"{{css.columnHeaderAnchor}} {{ctx.sortable}}\"><span class=\"{{css.columnHeaderText}}\">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>",
